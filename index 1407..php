...
$testimonials = [
    [
        'id'     => 'dr-alk',
        'photo'  => '/digibeat/assets/images/dra.webp',
    ...
    [
        'id'     => 'mr-ajith',
        'photo'  => '/digibeat/assets/images/ajith.webp',
    ...
    [
        'id'     => 'dr-sameeha',
        'photo'  => '/digibeat/assets/images/drs.webp',
    ...
    [
        'id'     => 'mr-kamal',
        'photo'  => '/digibeat/assets/images/kamal.webp',
        ...
        link.addEventListener('click', function(e) {
          ...
          if (target) {
            var isHomepage = window.location.pathname.indexOf('index.php') !== -1 || 
                             window.location.pathname === '/digibeat/' || 
